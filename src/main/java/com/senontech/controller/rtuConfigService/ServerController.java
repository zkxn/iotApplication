...
public class ServerController extends BaseController {
    ...
    public String add(@RequestBody String param) {
        try {
            return HttpUtil.requestShortConnect(SystemConfig.getRtuConfigKey(), "/server/add", param);
        } catch (Exception e) {
            log.error("接口名:add \n 错误内容:"+e);
            return returnError();
        }
    ...
    public String edit(@RequestBody String param) {
        try {
            return HttpUtil.requestShortConnect(SystemConfig.getRtuConfigKey(), "/server/edit", param);
        } catch (Exception e) {
            log.error("接口名:edit \n 错误内容:"+e);
            return returnError();
        }
    ...
    public String del(@RequestBody String param) {
        try {
            return HttpUtil.requestShortConnect(SystemConfig.getRtuConfigKey(), "/server/del", param);
        } catch (Exception e) {
            log.error("接口名:edit \n 错误内容:"+e);
            return returnError();
        }
    ...
    public String delList(@RequestBody String param) {
        try {
            return HttpUtil.requestShortConnect(SystemConfig.getRtuConfigKey(), "/server/delList", param);
        } catch (Exception e) {
    ...
    public String query(@RequestParam Integer serverId) {
        try {
            String str = SystemConfig.getRtuConfigKey() + "/server/query?serverId=" +serverId;
    ...
    public String queryList() {
        try {
            String str = SystemConfig.getRtuConfigKey() + "/server/queryList";
            return HttpUtil.requestGetConnect(str);
        } catch (Exception e) {
    ...
    public String queryPageList(Integer page,Integer size,String condition) {
        try {
            ...
            if(condition!=null&&condition!=""){
                str = SystemConfig.getRtuConfigKey() + "/server/queryPageList?page="+page+"&size="+size+"&condition="+ URLEncoder.encode(condition,"UTF-8");
            }else {
                str = SystemConfig.getRtuConfigKey() + "/server/queryPageList?page="+page+"&size="+size;
            }
            return HttpUtil.requestGetConnect(str);
        } catch (Exception e) {
